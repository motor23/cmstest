...
class Connecting extends Component {
    static propTypes = {
        shouldReloadPage: PropTypes.bool.isRequired
    };
    ...
    render() {
        const {shouldReloadPage} = this.props;
        return (
                ...
                <div className="slds-modal__container">
                    {shouldReloadPage ?
                        <div>
                            ...
                            <div>Проблема при подключении к серверу, перезагрузите страницу</div>
                        </div>
                        :
                        <div><Spinner/>Подключение к серверу...</div>
                    }
                </div>
            </div>
        );
